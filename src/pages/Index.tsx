...
const GAMES = [
  ...
  },
  {
    ...
    difficulty: "СРЕДНЯЯ",
    rules: [
      "У мирных есть общий домик — обычно горка — куда зомби не может войти.",
      "Мирные могут находиться в доме не дольше 1 минуты подряд.",
      "После минуты все мирные обязаны полностью покинуть дом на 3 секунды — это перезарядка.",
      "Если перезарядка не была сделана — защита снимается и зомби может войти в дом.",
      "Зомби побеждают, когда заражают всех мирных. Мирные — если выживают до конца времени.",
    ],
  },
  {
    emoji: "🔪",
